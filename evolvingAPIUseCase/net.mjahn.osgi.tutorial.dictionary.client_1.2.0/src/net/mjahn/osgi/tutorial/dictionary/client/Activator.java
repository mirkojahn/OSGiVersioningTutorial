...
public class Activator implements BundleActivator, CommandProvider{
	...
	public void start(BundleContext context) throws Exception {
		...
		properties.put("dict.console.version", "1.2.0");
	...
	public String getHelp() {
		...
		buffer.append("\tdc3 - short for dictionary check consults installed dictionary and checks if the given work is known or not.\n");
		buffer.append("\t\t dc3 <word to check> <language> <check lemma>\n");
		buffer.append("\t\t sample: dc3 birds en_US true\n");
		return buffer.toString();
	}
	
	public void _dc3(CommandInterpreter ci) throws Exception {
...
//		// debugging stuff #end
		...
		boolean lemma = Boolean.valueOf(ci.nextArgument());
