...
public class Activator implements BundleActivator, CommandProvider{
	...
	public void start(BundleContext context) throws Exception {
		...
		properties.put("dict.console.version", "1.1.0");
	...
	public String getHelp() {
		...
		buffer.append("\tdc2 - short for dictionary check consults installed dictionary and checks if the given work is known or not.\n");
		buffer.append("\t\t dc2 <word to check> <language>\n");
		buffer.append("\t\t sample: dc2 bird en_US\n");
		return buffer.toString();
	}
	
	public void _dc2(CommandInterpreter ci) throws Exception {
