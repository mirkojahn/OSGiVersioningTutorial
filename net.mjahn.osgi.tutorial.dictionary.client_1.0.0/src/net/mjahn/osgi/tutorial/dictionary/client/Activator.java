...
public class Activator implements BundleActivator, CommandProvider{
	...
	public void start(BundleContext context) throws Exception {
		...
		properties.put("dict.console.version", "1.0.0");
	...
	public String getHelp() {
		...
		buffer.append("\tdc - short for dictionary check consults installed dictionary and checks if the given work is known or not.\n");
		buffer.append("\t\t dc <word to check>\n");
		buffer.append("\t\t sample: dc bird\n");
